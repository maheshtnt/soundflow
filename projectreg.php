...
<h2 align="center" style="font-family:sans-serif;color:grey;opacity:100%;">Register to access a wide world of musical entertainment!</h2>
<form style="text-align:center;font-size:24;"action="projregsuccess.php"method="post">
Email:<br>
...
<input type="submit"name="submit"placeholder="Submit"value="Register"style="width:8em;font-size:18;">
</form><br><br><br>
