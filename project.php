...
$taddrs=[];
$timgs=[];
$sql0="SELECT tname, taddr, timg FROM tracks";
...
<li class="sth"></li>
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a><form action="gense.php"method="POST"><input type="submit" name="genre"class="but"value="Rock"></form></a>
      <a><form action="gense.php"method="POST"><input type="submit" name="genre"class="but"value="HipHop"></form></a>
      <a><form action="gense.php"method="POST"><input type="submit" name="genre"class="but"value="Classic"></form></a>
		<a><form action="gense.php"method="POST"><input type="submit" name="genre"class="but"value="Country"></form></a>
		<a><form action="gense.php"method="POST"><input type="submit" name="genre"class="but"value="EDM"></form></a>
	</div>
	</li>
	<li>
...
<hr>
<h3 align="left"style="font-family:sans-serif;opacity:100%;">Our recommendations:</h3>
<?php
$l=count($tnames);
$i=0;
while($i<$l){
...
<div class="wrapper">
<div class="container sel1"style="background-color:#0f0f0f;" onclick="playsel()">
...
<li class="sth2"onclick="playsel('lighttheme.mp3')">Repeat</li>
...
//I made the following function as a tester for the working of other functions
function alertme(){
